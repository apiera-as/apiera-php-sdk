...
final class UpdateProductTest extends AbstractTestUpdateOperation
{
     ...
     */
    protected function executeUpdateOperation(): ProductResponse
    {
        ...
        return $this->sdk->product()->update($request);
    }
