...
final class AlternateIdentifierGetTest extends AbstractTestGetOperation
{
     ...
     */
    protected function executeGetOperation(): AlternateIdentifierResponse
    {
        $request = new AlternateIdentifierRequest(
            iri: $this->buildUri('alternate_identifiers', $this->resourceId)
        );

        return $this->sdk->alternateIdentifier()->get($request);
    }
